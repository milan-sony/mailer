...
function Indexpage() {
    return (
        <div className='bg-white dark:bg-black w-full h-dvh flex flex-col justify-center items-center'>
            ...
            <p className='text-sm sm:text-base md:text-lg lg:text-xl font-Open-Sans font-medium text-gray-400 mb-5'>A simple yet flexible email automation platform</p>
